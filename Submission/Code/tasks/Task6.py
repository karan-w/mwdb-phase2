...
class Task6:
    ...
    def save_output(self, output_folder_path, type_label):
        output = {
            'associated_type_label': type_label
        }
...
def main():
    ...
    metadata, attributes, type_weight_matrix = task.read_latent_semantics(
    ...
    similarity_matrix = task.compute_similarity_matrix(
        reduced_query_feature_vector, type_weight_matrix)
