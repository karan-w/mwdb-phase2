...
output_folder_path="/Users/karanwadhwani/Documents/ASU/Fall2021/CSE515_MWDB/Project/mwdb-phase2/Submission/Outputs/Task7"

python3 tasks/Task7.py --query_image "${query_image}" --latent_semantics_file "${latent_semantics_file}" --images_folder_path "${images_folder_path}" --output_folder_path "${output_folder_path}"
